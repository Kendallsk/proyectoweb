    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
           ...
           <div class="modal-body">
            ...
            <div class="form-group">
                <label for="evidencia_pago"></label>
                <input wire:model="evidencia_pago" type="text" class="form-control" id="evidencia_pago" placeholder="Evidencia Pago">@error('evidencia_pago') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
